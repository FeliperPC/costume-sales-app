...
// Variable: SUITS_QUERY
// Query: *[_type == "suit" && defined(slug.current)]  | order(_createdAt desc) {    _id,    _createdAt,    name,    slug,    versions[]{      versionName,      price,      fullDescription,      images[]{        asset->{          _id,          url        }      }    }  }
export type SUITS_QUERY_RESULT = Array<{
  _id: string;
  _createdAt: string;
  name: string | null;
  slug: Slug | null;
